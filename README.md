# Projeto CIRURGIAS CARDÍACAS: Identificação de fatores de fracasso
## *Project HEART SURGERIES: Identification of failure factors*
...
## Vídeo do Projeto
##### [Vídeo](https://drive.google.com/file/d/1kkY0ogeB38BMyvEQ0bA2tkUDuS5mkzNX/view?usp=sharing)
...
|---------------|--------------------|-------------------------|
| Base 1        | https://base1.org/ |                         |

### Ferramentas
| Ferramenta        | Endereço na Web | Resumo descritivo e uso                                                                                                       |
|-------------------|-----------------|-------------------------------------------------------------------------------------------------------------------------------|
| Jupyter Notebook  |                 | Utilizado para o código de restruturação da base de dados e para os modelos.                                                  |
| Google Colab      |                 | Utilizado para as análise descritivas.                                                                                        |
| R Studio          |                 | Utilizado para a análise de correspondência.                                                                                  |
| SPSS Modeler 18.1 |                 | Utilizado para criação do modelo de árvore de decisão por possuir uma interface mais interativa para a construição dos ramos. |
